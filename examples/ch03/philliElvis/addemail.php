...
<body>
<!--PHP email query implemented within head. dbc saves the database connection details, always starts mysqli_connect-->
<?php
//saying connect to database 
  $dbc = mysqli_connect('root@localhost', '', '', 'elvis_store')
